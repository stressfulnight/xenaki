...
function L_1_:CreateWindow(L_26_arg0, L_27_arg1)
	...
	local L_29_ = createObject("Frame", {
		...
		BorderColor3 = Color3.fromRGB(81, 65, 79),
	...
	local L_35_ = createObject("UIGradient", {
		...
		Color = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(81, 65, 79)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(81, 65, 79))
		},
	})
	...
	local L_52_ = createObject("TextLabel", {
		...
		RichText = true,
		Text = "<b></b>",
		TextColor3 = Color3.fromRGB(81, 65, 79),
		TextSize = 14,
		TextXAlignment = Enum.TextXAlignment.Left,
	})
	...
	local L_67_ = createObject("TextButton", {
		Name = "ZExit",
		Parent = L_44_,
		BackgroundColor3 = Color3.fromRGB(0, 0, 08),
		Position = UDim2.new(0, 0, 0.6724890470504761, 0),
		Size = UDim2.new(1, 0, -0.02028985507786274, 50),
		AutoButtonColor = false,
		Font = Enum.Font.Gotham,
